...
class App(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("DART QuickReport — PE Quick DD")
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Entry(frm, textvariable=self.var_company, width=32).grid(
        ...
        self._log("DART QuickReport 준비 완료. 회사명을 입력하고 [분석 시작]을 누르세요.")
